import {makeGetStockMetrics} from './factories/makeGetStockMetrics';
...
/**
 * @description Lambda function to get products metrics.
 * @invoke sls invoke local -f GetStockMetrics -p src/lambdas/metrics/getStockMetrics/mock.json
 */
...
> = async event => {
  try {
    const controller = makeGetStockMetrics();
